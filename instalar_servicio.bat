@echo off
chcp 65001 >nul 2>&1
title ChatAgenda - Instalador de Servidor Silencioso
...
echo.
echo ===================================================
echo        ChatAgenda Server - Instalador Silencioso
echo ===================================================
echo.
...
echo.
echo [4/6] Configurando Tarea Programada (Servidor de fondo silencioso)...
...
echo.
echo [6/6] Iniciando servidor de forma invisible...
...
echo ===================================================
echo.
echo   El servidor ya se esta ejecutando en el fondo.
echo   URL local:     http://localhost:%PORT%
echo   El servidor iniciara automaticamente de forma
echo   completamente invisible (sin pedir permisos ni ventanas)
